      ...
      <div class="na-wrapper">
        <div class="na-wbox content">
          ...
          <div class="na-column23">
            <div class="na-col2">
              <div id="content" class="na-cbox author-page" role="main">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header>
					<h1 class="page-title"><?php printf( __( 'Author Archives: %s', 'twentyeleven' ), '<span><a class="" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
				</header>
