<?php
/**
 * Template Name: Showcase Template - HOME
      ...
      <div class="teaser">
        <div class="content">
          <?php 
            ...
            $page_data = get_page_by_title( 'Startseite-Teaser' );
      ...
      <div class="na-wrapper">
        <div class="na-wbox content">
            ...
            <div class="na-col2">
              <div id="content" class="na-cbox" role="main">
				...
				<?php
					...
					<div class="featured-post <?php echo $feature_class; ?>" id="featured-post-<?php echo $counter_slider; ?>">
          ...
          <div class="na-column32">
            <div class="na-col2">
              <div id="" class="na-cbox" role="main">
