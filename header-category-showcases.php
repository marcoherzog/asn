...
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo("template_url"); ?>/css/category-showcases.css" />
<!--[if lte IE 7]>
...
<script type="text/javascript" src="<?php bloginfo("template_url"); ?>/js/menuslider.js"></script>
